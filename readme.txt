...
* добавдено в здоровье сайта проверка на наличие тарифа 
* диагностика проблем - добавлена ссылка https://github.com/wpcraft-ru/wooms/issues/260
* XT: синк комплектов (сгруппированных продуктов) - глобальный рефакторинг с переводом очереди на Action Sheduler
