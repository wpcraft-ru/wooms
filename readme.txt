...
= 9.15 =
TBD
- Исправлено: обработка изображений вариаций больше не создает лишние или некорректные задачи повторной загрузки, если у вариации уже установлена актуальная миниатюра из МойСклад, а image_id сохраняется только после успешной загрузки файла. https://github.com/wpcraft-ru/wooms/issues/586
