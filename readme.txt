...
= 6.4 =
* дубль информации во вкладе Здаровье Сайта > Информация - чтобы пользователь мог скопировать 1 кнопкой информацию и отправить в поддержку https://github.com/wpcraft-ru/wooms/issues/254
* добавдено в здоровье сайта проверка на наличие тарифа https://github.com/wpcraft-ru/wooms/issues/252
...
* XT: синк комплектов (сгруппированных продуктов) - глобальный рефакторинг 
