...
class ProductAttributes
{
	...
	public static function render_settings_fields()
	{
		...
		printf('<p>По умолчанию доп. поля сохраняются как индивидуальные атрибуты для продукта, но если добавить атрибут с таким же названием в общие, то он будет сохраняться как общий с терминами таксономии. <a href="%s">Редактировать общие атрибуты</a></p>',  admin_url('edit.php?post_type=product&page=product_attributes'));
